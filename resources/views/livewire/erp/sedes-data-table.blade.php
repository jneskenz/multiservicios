                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        @can('sedes.view')
                                            <li><a class="dropdown-item" href="{{ route('sedes.show', $sede) }}"><i class="ti tabler-list-search me-2"></i>Ver detalles</a></li>
                                        @endcan
                                        @can('sedes.edit')
                                            <li><a class="dropdown-item" href="{{ route('sedes.edit', $sede) }}"><i class="ti tabler-edit me-2"></i>Editar</a></li>
                                        @endcan
                                        <li>
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5">
                                <div class="empty-state">
                                    <i class="ti tabler-building-warehouse" style="font-size: 4rem; color: #8b8fa3;"></i>
