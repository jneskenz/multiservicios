                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm {{ $local->estado ? 'btn-label-success' : 'btn-label-secondary' }} px-2" wire:click="toggleEstado({{ $local->id }})" title="{{ $local->estado ? 'Desactivar' : 'Activar' }}">
                                            <i class="ti tabler-{{ $local->estado ? 'check' : 'x' }}  me-1"></i>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                @can('locales.view')
                                                    <li><a class="dropdown-item" href="{{ route('locales.show', $local) }}"><i class="ti tabler-list-search me-2"></i>Ver detalles</a></li>
                                                @endcan
                                                @can('locales.edit')
                                                    <li><a class="dropdown-item" href="{{ route('locales.edit', $local) }}"><i class="ti tabler-edit me-2"></i>Editar</a></li>
                                                @endcan
                                                @can('locales.delete')
                                                <li>
